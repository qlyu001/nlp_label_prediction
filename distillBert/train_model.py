...
data = pd.read_csv("train_stanford4.csv", encoding="latin1").fillna(method="ffill")
print(data.tail(10))
...
f = open('tags_vals.pckl', 'wb')
pickle.dump(tags_vals, f)
f.close()

f = open('tag2idx.pckl', 'wb')
...
for _ in trange(epochs, desc="Epoch"):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        loss, x = model(b_input_ids, token_type_ids=None,
